...
// Run after editing location-spoofer.js, location-settings.js or location-spoofer-qx.js:
//   node scripts/gen-modules.mjs
import { readFileSync, writeFileSync } from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";

const dir = path.resolve(path.dirname(fileURLToPath(import.meta.url)), ".."); // 專案根目錄
const repoRoot = dir; // 專案根目錄
